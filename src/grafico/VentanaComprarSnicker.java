...
/**
 * VentanaComprarSnicker: Ventana que se muestra al momento de comprar un Snicker
 * */
public class VentanaComprarSnicker extends JPanel {
    private BufferedImage imagenFondo;
    private Clip clipMouseOver;
    private Clip clipClick;
    public VentanaComprarSnicker(CardLayout cardLayout, JPanel cards) {
        Random random = new Random();
        int numSerie = random.nextInt(1000) + 1;
        Snicker snicker = new Snicker(numSerie);
        ...
        try {
            ...
            BufferedImage img1 = ImageIO.read(new File("recursos/snicker.png"));
            imagen1.setIcon(new ImageIcon(img1.getScaledInstance(140, 140, Image.SCALE_SMOOTH)));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JLabel texto8 = new JLabel("Obtuviste:Snicker: \n Sabor 'chocolate ; almendras y caramelo'");
