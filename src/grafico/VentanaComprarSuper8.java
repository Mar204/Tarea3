...
/**
 * VentanaComprarSuper8: Ventana que se muestra al momento de comprar un Super8
 * */
public class VentanaComprarSuper8 extends JPanel {
    private BufferedImage imagenFondo;
    private Clip clipMouseOver;
    private Clip clipClick;
    public VentanaComprarSuper8(CardLayout cardLayout, JPanel cards) {
        Random random = new Random();
        int numSerie = random.nextInt(1000) + 1;
        Super8 super8= new Super8(numSerie);
        ...
        try {
            ...
            BufferedImage img1 = ImageIO.read(new File("recursos/super8.jpg"));
        ...
        JLabel texto8 = new JLabel("Obtuviste: Super 8r: \n Sabor 'galleta y chocolate'");
