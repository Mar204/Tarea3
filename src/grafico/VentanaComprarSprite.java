...
/**
 * VentanaComprarSprite: Ventana que se muestra al momento de comprar una Sprite
 * */
public class VentanaComprarSprite extends JPanel {
    private BufferedImage imagenFondo;
    private Clip clipMouseOver;
    private Clip clipClick;
    public VentanaComprarSprite(CardLayout cardLayout, JPanel cards) {
        Random random = new Random();
        int numSerie = random.nextInt(1000) + 1;
        Sprite sprite = new Sprite(numSerie);
        ...
        try {
            ...
            BufferedImage img1 = ImageIO.read(new File("recursos/sprite.png"));
            imagen1.setIcon(new ImageIcon(img1.getScaledInstance(120, 100, Image.SCALE_SMOOTH)));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JLabel texto8 = new JLabel("Obtuviste:Sprite: \n Sabor 'limón'");
