...
/**
 * VentanaComprarCoca: Ventana que se muestra al momento de comprar una CocaCola
 * */

public class VentanaComprarCoca extends JPanel {
    private BufferedImage imagenFondo;
    private Expendedor expendedor;
    private Clip clipMouseOver;
    private Clip clipClick;
    public VentanaComprarCoca(CardLayout cardLayout, JPanel cards) {
        Random random = new Random();
        int numSerie = random.nextInt(1000) + 1;
        CocaCola cocacola = new CocaCola(numSerie);
        ...
        try {
            ...
            imagen1.setIcon(new ImageIcon(img1.getScaledInstance(70, 100, Image.SCALE_SMOOTH)));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        JLabel texto8 = new JLabel("Obtuviste:CocaCola \n Sabor 'cola'");
